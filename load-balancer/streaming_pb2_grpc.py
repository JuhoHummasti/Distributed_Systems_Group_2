...
class StreamingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HealthCheck = channel.unary_unary(
                '/streaming.StreamingService/HealthCheck',
                request_serializer=streaming__pb2.HealthRequest.SerializeToString,
                response_deserializer=streaming__pb2.HealthResponse.FromString,
                _registered_method=True)
...
def add_StreamingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=streaming__pb2.HealthRequest.FromString,
                    response_serializer=streaming__pb2.HealthResponse.SerializeToString,
            ),
    }
...
class StreamingService(object):
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/streaming.StreamingService/HealthCheck',
            streaming__pb2.HealthRequest.SerializeToString,
            streaming__pb2.HealthResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
